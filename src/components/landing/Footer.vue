...
<template>
  <footer class="bg-gray-900 text-white px-6 py-6 text-center">
    <p class="text-lg md:text-base">&copy; 2025 NutriBuddy — Built for progress, not perfection.</p>
    <div class="mt-3 space-x-4 text-lg md:text-base">
